...
//-----------------------------------------------------------------------------
bool UQIYIVRHMDFunctionLibrary::isTemporalFoveationEnabled()
{
	return CVars::TemporalFoveationEnabled == 1;
}
//-----------------------------------------------------------------------------
void UQIYIVRHMDFunctionLibrary::enableTemporalFoveation(bool t)
{
...
//-----------------------------------------------------------------------------
float UQIYIVRHMDFunctionLibrary::getTextureMinimumPixelDensity()
{
	return CVars::TextureFoveationMinPixelDensity;
}
//-----------------------------------------------------------------------------
void UQIYIVRHMDFunctionLibrary::setTextureMinimumPixelDensity(float  x)
{
