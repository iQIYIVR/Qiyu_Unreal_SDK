...
UENUM()
enum class ControllerName : uint8
{
	LeftController = 1,
	RightController
};
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "IQIYIInput")
		void QIYIControllerStartVibration(const ControllerName ControllerIndex, const int32 amplitude, const int32 duration)
	{
#if QIYIVR_SUPPORTED_PLATFORMS
		QiyiVRCore::QVR_ControllerStartVibration((int32)ControllerIndex, amplitude, duration);
#endif
